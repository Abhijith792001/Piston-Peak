...
export default function ProductPageClient() {
  ...
  const jsonLd = {
    ...
    description: product.description || `Enhance your collection with this high-detail ${product.name} from ${product.brand}.`,
    brand: {
      '@type': 'Brand',
      name: product.brand,
    },
    offers: {
      '@type': 'Offer',
      url: `https://pistonpeak.web.app/product/${product.id}`,
      priceCurrency: 'INR',
      price: product.price,
